...
PRODUCTS = ["Pós-Graduação","Recorrência Pós","TEA","tDCS","Vagal","Lançamento Vagal","App","Fotobio","Matrículas","Impulsionamento Estratégia Instagram","Outros"]
...
<style>
  :root{--plane:#f9f9f7;--surface:#fcfcfb;--ink:#0b0b0b;--ink2:#52514e;--muted:#898781;
    ...
    --s1:#2a78d6;--s2:#eb6834;--s3:#1baf7a;--s4:#eda100;--s5:#e87ba4;--s6:#008300;--s7:#7b61c9;--s8:#ff7a3d;--s9:#38a9d9;--s10:#14a3a3;--sOut:#9a988f;
  ...
  :root[data-theme="dark"]{--plane:#0d0d0d;--surface:#1a1a19;--ink:#fff;--ink2:#c3c2b7;--muted:#898781;
    ...
    --s1:#3987e5;--s2:#d95926;--s3:#199e70;--s4:#c98500;--s5:#d55181;--s6:#008300;--s7:#9b82e0;--s8:#ff8c55;--s9:#4fb8e6;--s10:#1cc0c0;--sOut:#8a887f;
...
const COLORVAR = {"Pós-Graduação":"--s1","Recorrência Pós":"--s7","TEA":"--s2","tDCS":"--s3","Vagal":"--s4","Lançamento Vagal":"--s8","App":"--s5","Fotobio":"--s9","Matrículas":"--s10","Impulsionamento Estratégia Instagram":"--s6","Outros":"--sOut"};
const SHORT = {"Pós-Graduação":"Pós-Graduação","Recorrência Pós":"Recorrência Pós","TEA":"TEA","tDCS":"tDCS","Vagal":"Vagal","Lançamento Vagal":"Lanç. Vagal","App":"App","Fotobio":"Fotobio","Matrículas":"Matrículas","Impulsionamento Estratégia Instagram":"Impulsionamento","Outros":"Outros"};
...
const REV2P={tDCS:"tDCS",Vagal:"Vagal",Pos:"Pós-Graduação",NeuroApp:"App",TEA:"TEA",Outros:"Outros",
  ...
  "Lançamento Vagal":"Lançamento Vagal","Fotobio":"Fotobio","Matrículas":"Matrículas"};
